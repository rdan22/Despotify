# A small python script for muting the speaker when an ad starts to play in Spotify's Desktop App and resuming once the ad ends.
...
def locateIcon(icon):
    try:
        img = pyautogui.locateCenterOnScreen(f'{icon}', confidence = 0.5)
        return img
    except TypeError:
        pass
